...
public class Main {
	...
	public static final LoaderVersion LOADER_VERSION = new LoaderVersion("0.17.01");
	public static final String CLIENT_ZIP_NAME = "magia-edition";
	public static final String SERVER_ZIP_NAME = "magia-edition-server";
